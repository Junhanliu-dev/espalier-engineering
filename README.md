...
├── skills/                 # phase-loaded: coding, review, security, testing, requirements, grill, /espalier, /espalier-fix, /espalier-prune, /espalier-doctor, /espalier-ask, /espalier-audit, /espalier-map, /espalier-maprun
...
├── hooks/                  # programmatic gates: layer boundary check, pre-push gate, post-merge drift detect + backlink, map-guard; + the maprun run-lane engine

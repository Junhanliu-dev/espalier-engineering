...
This applies to **all** skill folders generated by this skill: espalier-coding, espalier-review, espalier-security, espalier-testing, espalier-requirements, espalier-grill, espalier (main), espalier-fix, espalier-prune, espalier-doctor, espalier-ask, and any additional ones added later.
...
- **Stage 11:** run 32 validation checks (31 in parallel, #25 serial for its tier table); print sorted output; non-zero exit if any failed.
